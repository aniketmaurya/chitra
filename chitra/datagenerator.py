# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/02_datagenerator.ipynb (unless otherwise specified).

__all__ = [
    'benchmark', 'get_filenames', 'get_label', 'ImageSizeList', 'Pipeline',
    'Dataset'
]
...
class ImageSizeList:
    def __init__(self, img_sz_list=None):
        ...
        if isinstance(img_sz_list, (list, tuple)):
            if len(img_sz_list) != 0 and not isinstance(
